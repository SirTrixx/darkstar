...
START_INVENTORY = 75; -- Starting inventory and satchel size.  Ignores values < 30.  Do not set above 80!
OPENING_CUTSCENE_ENABLE = 0; --Set to 1 to enable opening cutscenes, 0 to disable.
SUBJOB_QUEST_LEVEL = 14; -- Minimum level to accept either subjob quest.  Set to 0 to start the game with subjobs unlocked.
...
HARVESTING_BREAK_CHANCE = 0.10; -- % chance for the sickle to break during harvesting.  Set between 0 and 1.
EXCAVATION_BREAK_CHANCE = 0.10; -- % chance for the pickaxe to break during excavation.  Set between 0 and 1.
LOGGING_BREAK_CHANCE    = 0.10; -- % chance for the hatchet to break during logging.  Set between 0 and 1.
MINING_BREAK_CHANCE     = 10; -- % chance for the pickaxe to break during mining.  Set between 0 and 100.
HARVESTING_RATE         = 0.9; -- % chance to recieve an item from harvesting.  Set between 0 and 1.
EXCAVATION_RATE         = 0.9; -- % chance to recieve an item from excavation.  Set between 0 and 1.
LOGGING_RATE            = 0.9; -- % chance to recieve an item from logging.  Set between 0 and 1.
...
COFFER_MAX_ILLUSION_TIME = 60;  -- 1 hour
COFFER_MIN_ILLUSION_TIME = 120;  -- 30 minutes
CHEST_MAX_ILLUSION_TIME  = 60;  -- 1 hour
CHEST_MIN_ILLUSION_TIME  = 120;  -- 30 minutes
...
AF1_FAME = 40; -- base fame for completing an AF1 quest
AF2_FAME = 80; -- base fame for completing an AF2 quest
AF3_FAME = 120; -- base fame for completing an AF3 quest
