...
-- 0x0032 : 30 sceau conf�rie : choix entre clotho et lach�sis
-- 0x0018 : Apr�s achat d'un orb (qu'bia, yughott, palborough, giddeus)
-- 0x0008 : Apr�s achat d'un orb (yughott, palborough, giddeus, qu'bia, ghelsba)
-- 0x0004 : Apr�s achat d'un orb (yughott, palborough, giddeus, ghelsba)
-- 0x000a : Apr�s achat d'un orb (yughott, palborough, giddeus)
...
-- 0x0016 : Trade d'un orb utilis� (il le recup)
-- 0x0019 : Un seul �change autoris� par semaine
